...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      info: "contact@swarajability.org",
    },
    {
            ...
            <div className="bg-white rounded-lg shadow-md p-8 h-full border border-gray-100">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-swaraj-blue/10 p-3 rounded-full text-swaraj-blue hover:bg-swaraj-blue hover:text-white transition-colors duration-300">
